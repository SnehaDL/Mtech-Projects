...
int main()
    {int choice,m,n,x,start,i,j,pos,min,a[15],count;
     count=0;
     printf("===================================================\n");
     printf("Simulater to implement Disk Scheduling Algorithms\n");
     printf("===================================================\n");
     printf("- By - - - Sneha - - - & - - - Sravya - - - -\n");
     printf("===================================================\n\n\n\n");
     printf("===================================================\n");
     printf("Please enter the requirements\n");
     printf("===================================================\n");
    ...
    printf("\n\n");
    printf("===================================================\n");
    printf("Enter your choice of algorithm to perform the Disk Scheduling\n");
    printf("===================================================\n");
     do
